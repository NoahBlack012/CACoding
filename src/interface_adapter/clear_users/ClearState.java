...
public class ClearState {
    ...
    public String getDeleteUsersError(){return deleteUsersError; }
    ...
    public void setDeleteUsersError(String deleteUsersError){ this.deleteUsersError = deleteUsersError;}
    @Override
